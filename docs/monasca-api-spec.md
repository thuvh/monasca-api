...
#### Request Examples
```
GET /v2.0/metrics/dimensions/values?dimension_name=dimension1:value1 HTTP/1.1
Host: 192.168.10.4:8080
Content-Type: application/json
X-Auth-Token: 27feed73a0ce4138934e30d619b415b0
Cache-Control: no-cache
...
````
{
    "links": [
        {
            "rel": "self",
            "href": "http://192.168.10.4:8080/v2.0/metrics/dimensions/values"
        },
        {
            "rel": "next",
            "href": "http://192.168.10.4:8080/v2.0/metrics/dimensions/values?offset=dimensionValue2"
        }
    ],
    "elements": [
        {
