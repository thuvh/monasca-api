...
* sub_alarms ({string, string, [string]) - The sub-alarms stated of when the alarm state transition occurred.
...
[
   {
        ...
        "sub_alarms": [
            {
                "sub_alarm_expression": "avg(cpu.system_perc{hostname=devstack}) > 15.0",
                "sub_alarm_state": "OK",
                "current_values": [
                    1.5
                ]
    ...
    },
    {
        ...
        "sub_alarms": [
            {
                "sub_alarm_expression": "avg(mysql.performance.slow_queries) > 10.0 times 3",
                "sub_alarm_state": "OK",
                "current_values": [
                    29.23069852941176,
                    20.146139705882355,
...
[
    {
        ...
        "sub_alarms": [
            {
                "sub_alarm_expression": "avg(cpu.idle_perc) < 10.0 times 3",
                "sub_alarm_state": "ALARM",
                "current_values": [
                    0,
                    0,
