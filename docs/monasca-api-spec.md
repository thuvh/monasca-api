...
* description (string(255), required) -  A description of an alarm definition. Will default to empty if omitted.
* expression (string, required) - An alarm expression.
* match_by ([string], required) - The metric dimensions to use to create unique alarms. If specified, this MUST be the same as the existing value for match_by
