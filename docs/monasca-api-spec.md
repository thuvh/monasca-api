...
* exclusions (string, optional) - A dictionary  by specified as a comma separated array of (key, value) pairs as `key1:value1,key2:value2, ...`.
...

{
	...
	"matchers": ["alarmName", "_metrics_name_", "_metrics_dimensions_hostname_"],
	"exclusions": {"alarmName": "cpu_too_high", "_metrics_dimensions_hostname_": "host1"},
	"group_wait": "10s",
	"repeat_interval": "1h",
...
* matchers ([string(255)], required) - The metric dimension keys to match to the alarm group dimensions.
* group_wait (string(10), optional) - Wait time to send the initial notification.
* repeat_interval (string(10), optional) - Wait time to resend the group notification.
* exclusions (string, optional) - A dictionary  by specified as a comma separated array of (key, value) pairs to exclude from a specific alarm group.
...
```
{
	...
	"matchers": [
		"alarmName", 
		"_metrics_name_", 
		"_metrics_dimensions_hostname_"
	],
	"exclusions": {
		"alarmName": "cpu_too_high", 
		"_metrics_dimensions_hostname_": "host1"
	},
	"group_wait": "10s",
	"repeat_interval": "1h",
	"alarm_actions": [
...
[
  {
    ...
    "exclusions": "_metrics_dimensions_hostname_=host2",
    "repeat_interval": "2h",
  ...
  },
  {
    ...
    "exclusions": "_metrics_dimensions_hostname_=host4",
    "repeat_interval": "4h",
...
#### Response Body
Returns a JSON alarm group definition object with the following parameters:
