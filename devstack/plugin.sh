...
function install_monasca_cassandra {
    ...
    # Recent Cassandra needs openjdk-8-jdk
    ...
    PUBLIC_KEY=`sudo apt-get update 2>&1 | awk '/NO_PUBKEY/ {print $21}'`
...
function clean_monasca_cassandra {
    ...
    sudo apt-get -y purge openjdk-8-jdk cassandra
...
function install_monasca_api_python {
    ...
    pip_install cassandra-driver>=2.1.4
