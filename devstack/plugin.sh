...
function install_monasca_api_java {
    ...
    (sudo mkdir -p /etc/monasca-api ; ln -sf /etc/monasca/api-config.yml /etc/monasca-api/api-config.yml)
}
...
function install_monasca_api_python {
    ...
    mkdir -p /etc/monasca-api
    ln -sf /etc/monasca/api-config.conf /etc/monasca-api/api-config.conf
    ln -sf /etc/monasca/api-config.ini /etc/monasca-api/api-config.ini
    ln -sf /etc/monasca/api-logging.conf /etc/monasca-api/api-logging.conf
}
