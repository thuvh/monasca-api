...
function install_vertica {
    ...
    sudo git clone https://github.com/hpcloud-mon/ansible-monasca-schema.git "${MONASCA_BASE}"/ansible-monasca-schema

    /opt/vertica/bin/vsql -U dbadmin -w password < "${MONASCA_BASE}"/ansible-monasca-schema/files/mon_alarms_schema.sql

    sudo /opt/vertica/bin/vsql -U dbadmin -w password < "${MONASCA_BASE}"/ansible-monasca-schema/files/mon_metrics_schema.sql
