...
function install_monasca_common {
    ...
    if [[ ! -d /opt/stack/monasca-common ]]; then
        ...
        sudo git clone https://git.openstack.org/openstack/monasca-common /opt/stack/monasca-common
...
function install_monasca_thresh {
    ...
    if [[ ! -d /opt/stack/monasca-thresh ]]; then
      ...
      sudo git clone https://git.openstack.org/openstack/monasca-thresh /opt/stack/monasca-thresh
...
function install_monasca_keystone_client {
    ...
    sudo apt-get -y install python-dev
     ...
     if [[ ! -d /opt/stack/python-keystoneclient ]]; then
        ...
        sudo git clone https://git.openstack.org/openstack/python-monascaclient /opt/stack/python-keystoneclient
