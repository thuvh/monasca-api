...
function install_monasca_api_python {
    ...
    (cd /opt/monasca-api ; sudo ./bin/pip install -c $DEST/requirements/upper-constraints.txt $MONASCA_COMMON_SRC_DIST)

    (cd /opt/monasca-api ; sudo ./bin/pip install -c $DEST/requirements/upper-constraints.txt $MONASCA_STATSD_SRC_DIST)
    ...
    (cd /opt/monasca-api ; ./bin/pip install -c $DEST/requirements/upper-constraints.txt $MONASCA_API_SRC_DIST)
...
function install_monasca_persister_python {
    ...
    (cd /opt/monasca-persister ; sudo ./bin/pip install -c $DEST/requirements/upper-constraints.txt $MONASCA_COMMON_SRC_DIST)

    (cd /opt/monasca-persister ; ./bin/pip install -c $DEST/requirements/upper-constraints.txt $MONASCA_PERSISTER_SRC_DIST)
...
function install_monasca_notification {
    ...
    (cd /opt/monasca ; sudo ./bin/pip install -c $DEST/requirements/upper-constraints.txt $MONASCA_COMMON_SRC_DIST)

    (cd /opt/monasca ; sudo ./bin/pip install -c $DEST/requirements/upper-constraints.txt $MONASCA_STATSD_SRC_DIST)

    (cd /opt/monasca ; ./bin/pip install -c $DEST/requirements/upper-constraints.txt $MONASCA_NOTIFICATION_SRC_DIST)
...
function install_monasca_keystone_client {
    ...
    (cd /opt/monasca ; sudo ./bin/pip install -c $DEST/requirements/upper-constraints.txt python-keystoneclient)

    (cd /opt/monasca ; sudo ./bin/pip install -c $DEST/requirements/upper-constraints.txt keystoneauth1)
...
function install_monasca_horizon_ui {
    ...
    sudo pip install -c $DEST/requirements/upper-constraints.txt python-monascaclient
