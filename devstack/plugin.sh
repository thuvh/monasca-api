...
# settings for dependent libraries
GITDIR["python-monascaclient"]=$DEST/python-monascaclient
...
function install_monasca_agent {
    ...
    setup_develop $MONASCA_AGENT_DIR

    if use_library_from_git "python-monascaclient"; then
        git_clone_by_name "python-monascaclient"
        setup_dev_lib "python-monascaclient"
    fi

    pip_install kafka-python==0.9.2
