...
function unstack_monasca {
    ...
    stop_service monasca-agent.target || true
...
function clean_monasca_agent {
    ...
    sudo rm /etc/systemd/system/monasca-agent.target
    sudo rm /etc/systemd/system/monasca-collector.service
    sudo rm /etc/systemd/system/monasca-forwarder.service
    sudo rm /etc/systemd/system/monasca-statsd.service
