...
function install_monasca_grafana {
    ...
    sudo chown -R grafana:grafana /var/lib/grafana /var/lib/grafana/plugins /var/log/grafana

    cd /var/lib/grafana/plugins
    git clone https://github.com/openstack/monasca-grafana-datasource.git
