...
function install_schema {
    ...
    sudo mysql -h "127.0.0.1" -uroot -p${DATABASE_PASSWORD} < /opt/monasca/sqls/mon.sql || echo "Did the schema change? This process will fail on schema changes."
    ...
    # must login as root@localhost
    sudo mysql -h "127.0.0.1" -uroot -p${DATABASE_PASSWORD} < /opt/monasca/sqls/winchester.sql || echo "Did the schema change? This process will fail on schema changes."
