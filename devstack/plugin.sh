...
function start_monasca_services {
    ...
    if is_service_enabled monasca-agent; then
        ...
        [[ -f /etc/systemd/system/monasca-agent.target ]] start_service monasca-agent.target || restart_service monasca-agent.targettrue
        [[ -f /etc/systemd/system/monasca-agent.service ]] start_service monasca-agent.service || start_service monasca-agent.service
    fi
}
