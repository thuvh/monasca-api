...
function install_monasca_notification {
    ...
    MONASCA_STATSD_SRC_DIST=$(ls -td "$MONASCA_BASE"/monasca-statsd/dist/monascastatsd*.tar.gz | head -1)
    ...
    pip_install --allow-unverified simport $MONASCA_STATSD_SRC_DIST
