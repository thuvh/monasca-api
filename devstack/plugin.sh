...
function install_monasca_api_python {
    ...
    local dbEncoding="charset=utf8"
    if is_service_enabled postgresql; then
      dbEncoding="client_encoding=utf8"
    fi
    local dbAlarmUrl=`get_database_type_$DATABASE_TYPE`://$MONASCA_API_DATABASE_USER:$DATABASE_PASSWORD@$DATABASE_HOST/mon?$dbEncoding
