...
function install_schema {
    ...
    if [[ ${SERVICE_HOST} ]]; then
        ...
        sudo mysql -h ${SERVICE_HOST} -uroot -psecretmysql < /opt/monasca/sqls/mon.sql || echo "Did the schema change? This process will fail on schema changes."
    ...
    if [[ ${SERVICE_HOST} ]]; then
        ...
        sudo mysql -h ${SERVICE_HOST} -uroot -psecretmysql < /opt/monasca/sqls/winchester.sql || echo "Did the schema change? This process will fail on schema changes."
