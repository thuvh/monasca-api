...
function install_monasca_notification {
    ...
    MONASCA_STATSD_SRC_DIST=$(ls -td "$MONASCA_BASE"/monascastatsd/dist/monascastatsd*.tar.gz | head -1)
    ...
    (cd /opt/monasca-notification ; ./bin/pip install $MONASCA_STATSD_SRC_DIST)
