...
function install_zookeeper {
    ...
    echo_summary "Install Zookeeper"
...
function install_influxdb {
    ...
    echo_summary "sleep for 20 seconds to let influxdb elect a leader"
...
function install_cli_creds {
    ...
    echo_summary "Install CLI Creds"
...
function install_openjdk_7_jdk {
    ...
    echo_summary "Install openjdk_7_jdk"
...
function clean_openjdk_7_jdk {
    ...
    echo_summary "Clean openjdk_7_jdk"
...
function install_monasca_common {
    ...
    echo_summary "Install monasca_common"
...
function clean_monasca_common {
    ...
    echo_summary "Clean monasca_common"
...
function install_monasca_api {
    ...
    echo_summary "Install monasca_api"
...
function clean_monasca_api {
    ...
    echo_summary "Clean monasca_api"
...
function install_monasca_persister {
    ...
    echo_summary "Install monasca_persister"
...
function clean_monasca_persister {
    ...
    echo_summary "Clean monasca_persister"
...
function install_monasca_notification {
    ...
    echo_summary "Install monasca_notification"
    ...
    sudo chmod 0640 /etc/monasca/notification.yaml
...
function clean_monasca_notification {
    ...
    echo_summary "Clean monasca_notification"
...
function install_monasca_thresh {
    ...
    echo_summary "Install monasca_thresh"
...
function clean_monasca_thresh {
    ...
    echo_summary "Clean monasca_thresh"
...
function install_keystone {
    ...
    echo_summary "Install monasca keystone service"
...
function clean_keystone {
    ...
    echo_summary "Clean monasca keystone service"
...
function install_monasca_agent {
    ...
    echo_summary "Install monasca_agent"
...
function clean_monasca_agent {
    ...
    echo_summary "Clean monasca_agent"
...
function install_monasca_smoke_test {
    ...
    echo_summary "Install monasca_smoke_test"
    ...
    sudo /opt/monasca/bin/python /opt/monasca/hpcloud-mon-monasca-ci-7a45d29/tests/smoke/smoke2.py

    OS_USERNAME=test OS_PASSWORD=password OS_PROJECT_NAME=test OS_AUTH_URL=http://127.0.0.1:35357/v3 bash -c 'sudo /opt/monasca/bin/python /opt/monasca/hpcloud-mon-monasca-ci-7a45d29/tests/smoke/smoke.py'

}

function clean_monasca_smoke_test {

    echo_summary "Clean monasca_smoke_test"
