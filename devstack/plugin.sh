...
function install_zookeeper {
    ...
    start_service zookeeper || restart_service zookeeper
...
function install_monasca_grafana {
    ...
    if [ ! -d "${MONASCA_GRAFANA_DATASOURCE_DIR}"]
	git_clone $MONASCA_GRAFANA_DATASOURCE_REPO $MONASCA_GRAFANA_DATASOURCE_DIR \
	    $MONASCA_GRAFANA_DATASOURCE_BRANCH
    fi
