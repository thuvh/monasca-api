...
function clean_zookeeper {
    ...
    if is_zookeeper_enabled; then
        ...
        sudo rm -rf /opt/apache-zookeeper-${ZOOKEEPER_VERSION}
...
function install_zookeeper {
    ...
    if is_zookeeper_enabled; then
        ...
        local zookeeper_tarball=apache-zookeeper-${ZOOKEEPER_VERSION}.tar.gz
        ...
        sudo ln -sf /opt/apache-zookeeper-${ZOOKEEPER_VERSION} /opt/zookeeper
