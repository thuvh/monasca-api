...
ALTER TABLE ONLY alarm_inhibition_definition_source_match
    ADD CONSTRAINT alarm_inhibition_definition_source_match_pkey PRIMARY KEY (alarm_inhibition_definition_id);

ALTER TABLE ONLY alarm_inhibition_definition_target_match
    ADD CONSTRAINT alarm_inhibition_definition_target_match_pkey PRIMARY KEY (alarm_inhibition_definition_id);

ALTER TABLE ONLY alarm_inhibition_definition_exclusion
    ADD CONSTRAINT alarm_inhibition_definition_exclusion_pkey PRIMARY KEY (alarm_inhibition_definition_id);
-- indexes
---
...
ALTER TABLE ONLY alarm_inhibition_definition
    ADD CONSTRAINT fk_alarm_inhibition_definition_id FOREIGN KEY (rule_id)
