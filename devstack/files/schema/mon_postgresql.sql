...
ALTER TABLE ONLY group_rule
    ADD CONSTRAINT group_rule_pkey PRIMARY KEY (rule_id);
...
ALTER TABLE ONLY inhibit_rule
    ADD CONSTRAINT inhibit_rule_pkey PRIMARY KEY (rule_id);

ALTER TABLE ONLY silence_rule
    ADD CONSTRAINT silence_rule_pkey PRIMARY KEY (rule_id);
