...
ALTER TABLE ONLY alarm_inhibition_definition_exclusion
    ADD CONSTRAINT fk_exclusions_alarm_inhibition_definition_id FOREIGHN KEY (alarm_inhibition_definition_id)
    REFERENCES alarm_rule_definition(id) ON DELETE CASCASDE;
