...
CREATE TABLE alarm_inhibition_manager_source_match (
    alarm_inhibition_manager_id character varying(36) NOT NULL,
...
ALTER TABLE ONLY alarm_inhibition_manager
    ADD CONSTRAINT alarm_inhibition_manager_pkey PRIMARY KEY (id);
---
-- indexes
---
...
ALTER TABLE ONLY alarm_inhibition_manager_source_match
    ADD CONSTRAINT fk_source_match_alarm_inhibition_manager_id FOREIGN KEY (alarm_inhibition_manager_id)
    REFERENCES alarm_inhibition_manager(id);

ALTER TABLE ONLY alarm_inhibition_manager_target_match
    ADD CONSTRAINT fk_target_match_alarm_inhibition_manager_id FOREIGN KEY (alarm_inhibition_manager_id)
    REFERENCES alarm_inhibition_manager(id);
