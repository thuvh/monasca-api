...
ALTER TABLE ONLY alarm_group_definition
    ADD CONSTRAINT alarm_group_definition_pkey PRIMARY KEY (id);
...
---
ALTER TABLE ONLY alarm_group_definition_action
    ADD CONSTRAINT fk_action_alarm_group_definition_id FOREIGN KEY
    (alarm_group_definition_id)
    REFERENCES alarm_group_definition(id);
