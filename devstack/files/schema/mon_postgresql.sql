...
CREATE USER monapi WITH PASSWORD 'password';
CREATE USER thresh WITH PASSWORD 'password';
---
-- grants
-- TOOD(trebskit) see that we see the same grants for the same users as that is done in mysql
---
GRANT ALL PRIVILEGES ON DATABASE mon TO notification;
GRANT ALL PRIVILEGES ON DATABASE mon TO monapi;
GRANT ALL PRIVILEGES ON DATABASE mon TO thresh;
GRANT ALL PRIVILEGES ON DATABASE mon TO PUBLIC;
