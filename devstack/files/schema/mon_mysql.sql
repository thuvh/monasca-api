...
CREATE TABLE `alarm_rule` (
  ...
  `alarm_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `inhibition_source_id` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  KEY `fk_rules_alarm_id` (`alarm_id`),
  PRIMARY KEY (`alarm_rule_id`),
  ...
  CONSTRAINT `fk_inhibition_source_id` FOREIGN KEY (`inhibition_source_id`) REFERENCES `alarm` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `alarm_inhibition_definition` (
  ...
  PRIMARY KEY (`rule_id`),
  CONSTRAINT `fk_alarm_inhibition_definition_id` FOREIGN KEY (`rule_id`) REFERENCES `alarm_rule_definition` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
