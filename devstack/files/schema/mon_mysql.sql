...
CREATE TABLE `alarm_group_definition_action` (
  ...
  `alarm_state` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `action_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`alarm_group_definition_id`,`action_id`),
  CONSTRAINT `fk_action_alarm_group_definition_id` FOREIGN KEY (`alarm_group_definition_id`) REFERENCES `alarm_group_definition` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `alarm_group_definition_exclusion` (
  ...
  `value` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  CONSTRAINT `fk_exclusion_alarm_group_definition_id` FOREIGN KEY (`alarm_group_definition_id`) REFERENCES `alarm_group_definition` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
