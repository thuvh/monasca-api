...
(cd $BASE/new/tempest/; sudo sh -c 'testr list-tests monasca_tempest_tests')
(cd $BASE/new/tempest/; sudo cat monasca_tempest_tests)
(cd $BASE/new/tempest/; sudo cat monasca_tempest_tests | grep gate > monasca_tempest_tests_gate)
