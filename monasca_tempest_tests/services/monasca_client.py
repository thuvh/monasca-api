...
class MonascaClient(rest_client.RestClient):
    ...
    def create_inhibit_rules(self, alarm_inhibition_definitions):
        uri = 'inhibit-rules'
        request_body = json.dumps(alarm_inhibition_definitions)
        resp, response_body = self.post(uri, request_body)
        return resp, json.loads(response_body)

    def create_silence_rules(self, silence_definitions):
        uri = 'silence-rules'
    ...
    def update_inhibition_definition(self, rule_id, name, description,
                                     expression, **kwargs):
        uri = 'inhibit-rules/' + rule_id
        request_body = {}
        request_body['name'] = name
    ...
    def update_silence_definition(self, rule_id, name, description, expression,
    ...
    def patch_group_definition(self, rule_id, name=None, description=None,
                               expression=None, group_wait=None,
