...
class MonascaClient(rest_client.RestClient):
    ...
    def list_inhibition_rules(self, query_params=None):
        uri = 'inhibit-rules'
        if query_params is not None:
            uri = uri + query_params
        resp, response_body = self.get(uri)
    ...
    def update_group_rule(self, rule_id, name, description, expression,
    ...
    def update_inhibit_rule(self, rule_id, name, description, expression, **kwargs):
        uri = 'inhibit-rules/' + rule_id
        request_body = {}
        request_body['name'] = name
        request_body['description'] = description
    ...
    def update_silence_rule(self, rule_id, name, description, expression, start_time,
    ...
    def patch_group_rule(self, rule_id, name=None, description=None, expression=None,
    ...
    def patch_inhibit_rule(self, rule_id, name=None, description=None,
