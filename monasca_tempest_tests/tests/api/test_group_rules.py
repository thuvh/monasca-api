...
class TestGroupRules(base.BaseMonascaTest):
    ...
    def test_get_group_rules(self):
        ...
        resp, response_body = self.monasca_client.get_group_rule(
            response_body_list[0]['rule_id'])
        self.assertEqual(200, resp.status)
        self._verify_element_set(response_body)
        self._verify_group_rules_element(response_body,
    ...
    def test_get_group_rules_with_invalid_id(self):
        ...
        self.assertRaises(exceptions.NotFound,
                          self.monasca_client.get_group_rule, def_id)
    ...
    def test_update_group_rules(self):
        ...
        resp, response_body = self.monasca_client.update_group_rule(
            str(response_body_list[0]['rule_id']), updated_name, updated_description,
            expression, updated_group_wait, updated_repeat_interval,
    ...
    def test_update_group_rules_with_expression(self):
        ...
        self.assertRaises(exceptions.UnprocessableEntity,
                          ...
                          str(response_body_list[0]['rule_id']), updated_name,
        ...
        self.assertRaises(exceptions.UnprocessableEntity,
                          self.monasca_client.update_group_rule,
                          str(response_body_list[0]['rule_id']), updated_name,
                          updated_description, expression, updated_group_wait,
    ...
    @test.attr(type="python_only")
    def test_update_group_rules_update_notifications(self):
        notification_name = data_utils.rand_name('notification-')
        notification_type = 'EMAIL'
        address = 'root@localhost'
    ...
    def test_update_group_rules_with_invalid_id(self):
        ...
        self.assertRaises(exceptions.NotFound,
                          self.monasca_client.update_group_rule,
                          rule_id, updated_name, updated_description,
                          updated_expression, '30s', '1h', [], [], [])
    ...
    def test_patch_group_rules(self):
        ...
        resp, response_body = self.monasca_client.patch_group_rule(
            rule_id=response_body_list[0]['rule_id']
        )
        self.assertEqual(200, resp.status)
    ...
    def test_patch_group_rules_with_expression(self):
        ...
        self.assertRaises(exceptions.UnprocessableEntity,
                          ...
                          str(response_body_list[0]['rule_id']), patched_name,
                          patched_description, "group by hostname, service",
                          patched_group_wait, patched_repeat_interval, [], [], [])

        self.assertRaises(exceptions.UnprocessableEntity,
                          self.monasca_client.update_group_rule,
                          str(response_body_list[0]['rule_id']), patched_name,
                          patched_description, expression, patched_group_wait,
    ...
    def test_patch_group_rules_actions(self):
        ...
        self.assertEqual(200, resp.status)
        self._verify_update_patch_group_rule(response_body, None, None, None, None,
                                             notification_id)
    ...
    def test_delete_group_rules(self):
        ...
        for element in elements:
            if element['rule_id'] == response_body_list[0]['rule_id']:
    ...
    def test_delete_group_rules_with_invalid_id(self):
        def_id = data_utils.rand_name()
        self.assertRaises(exceptions.NotFound,
                          self.monasca_client.delete_group_rule, def_id)
    ...
    def _create_group_rules(self, number_of_rules, **kwargs):
        ...
        for i in xrange(number_of_rules):
            ...
            alarm_definition = helpers.create_group_rule(
                name=name,
                description=desc,
                expression=expression,
    ...
    def _verify_group_rules_element(self, response_body, res_body_create_group_rule):
        ...
        self.assertEqual(response_body['rule_id'], res_body_create_group_rule['rule_id'])
        self.assertEqual(response_body['description'],
    ...
    def _verify_update_patch_group_rule(self, response_body, updated_name,
                                        updated_description, updated_group_wait,
                                        updated_repeat_interval, notification_id):
        if updated_name:
