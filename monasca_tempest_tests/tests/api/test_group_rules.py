...
class TestGroupRules(base.BaseMonascaTest):
    ...
    def test_update_group_rules(self):
        ...
        self.assertEqual(200, resp.status)
        self._verify_update_patch_group_rule(response_body, updated_name, 
                                             updated_description, 
                                             updated_group_wait,
    ...
    def test_patch_group_rules_actions(self):
        ...
        self.assertEqual(200, resp.status)
        self._verify_update_patch_group_rule(response_body, None, None,
                                                   None, None,
                                                   notification_id)
    ...
    def _verify_create_group_rules(self, resp, response_body, group_rule):
        ...
        self.assertEqual(group_rule['expression'], 
        ...
        if 'group_wait' in group_rule:
            self.assertEqual(group_rule['group_wait'], 
