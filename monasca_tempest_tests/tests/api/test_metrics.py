...
class TestMetrics(base.BaseMonascaTest):
    ...
    def _verify_list_measurements_measurement(self, measurement,
                                              ...
                                              test_vm_value):
        time_iso_millis, time_iso_millis_plus, time_iso_millis_minus = \
            self._timestamp_to_iso_millis_pm_one(test_metric['timestamp'])
    ...
    def _timestamp_to_iso_millis_pm_one(self, timestamp):
        ...
        if float(time_iso_microsecond[0:4]) == 0.0:
            ...
            time_iso_millis_minus = \
                ...
                + 'Z'
        return time_iso_millis, time_iso_millis_plus, time_iso_millis_minus
