...
class TestAlarms(base.BaseMonascaTest):
    ...
    def test_list_alarms_sort_by(self):
        ...
        resp, response_body = self.monasca_client.list_alarms('?alarm_deifnition_id=' + alarm_definition_ids[0])
        self._verify_list_alarms_elements(resp, response_body,
                                          expect_num_elements=3)

        resp, response_body = self.monasca_client.list_alarms('?alarm_definition_id=' + alarm_definition_ids[0] +
