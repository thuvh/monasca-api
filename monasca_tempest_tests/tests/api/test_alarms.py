...
class TestAlarms(base.BaseMonascaTest):
    ...
    def test_list_alarms_by_metric_dimensions(self):
        ...
        self._test_list_alarms_elements(resp, response_body,
                                        expect_num_elements=1)
        query_parms = '?alarm_definition_id=' + str(
            alarm_definition_ids[0]) + '&metric_dimensions=key-2:value-2,' \
                                       'key-1:value-1'
    ...
    def _test_list_alarms_elements(self, resp, response_body,
                                   expect_num_elements):
        self.assertEqual(200, resp.status)
