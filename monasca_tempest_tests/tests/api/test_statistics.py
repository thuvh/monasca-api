...
class TestStatistics(base.BaseMonascaTest):
    ...
    def test_list_statistics(self):
        ...
        self._test_column(column, num_statistics_method)
        statistics = element['statistics'][0]
        self._test_statistics(statistics, metric_value1, metric_value2)
    ...
    def test_list_statistics_with_no_merge_metrics(self):
        ...
        query_param = '?name=' + str(self._test_name) + '&start_time=' + \
            ...
            timestamp_to_iso(self._start_timestamp + 1000 * 3)
        ...
        for i in xrange(constants.MAX_RETRIES):
            ...
            for element in elements:
                if str(element['name']) == self._test_name and len(
                    ...
                    end_timestamp = self._start_timestamp + 1000 * 3
    ...
    def _test_statistics(self, statistics, num1, num2):
    ...
    def _test_column(self, column, num_statistics_method):
