        ...
        if elements:
            ...
            for el_id in el_ids:
                for limit in xrange(1, len_of_elements):
                    ...
                    first_element = elements[0]
                    self.assertEqual(el_id, first_element['id'])
