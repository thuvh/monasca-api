...
class TestNotificationMethods(base.BaseMonascaTest):
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_create_notification_method_with_invalid_domain_for_webhook(self):
        notification = helpers.create_notification(type="WEBHOOK", address="http://localhost.error:3313")
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          self.monasca_client.create_notifications,
                          notification)
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_create_notification_method_with_invalid_port_for_webhook(self):
        notification = helpers.create_notification(type="WEBHOOK", address="http://localhost.test:5533AA")
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          self.monasca_client.create_notifications,
                          notification)
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_create_notification_method_with_invalid_multiple_ports_for_webhook(self):
        notification = helpers.create_notification(type="WEBHOOK", address="http://localhost:133:333")
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          self.monasca_client.create_notifications,
                          notification)
