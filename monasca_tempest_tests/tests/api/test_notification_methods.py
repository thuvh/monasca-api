...
class TestNotificationMethods(base.BaseMonascaTest):
    ...
    @test.attr(type="gate")
    def test_create_notification_method_periodic_interval_not_defined(self):
        notification = helpers.create_notification(periodic_interval=None)
        resp, response_body = self.monasca_client.create_notifications(
            notification)
        self.assertEqual(201, resp.status)
        id = response_body['id']
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_create_notification_method_with_invalid_float_periodic_interval(self):
        notification = helpers.create_notification(periodic_interval=1.2)
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          self.monasca_client.create_notifications,
                          notification)
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_create_notification_method_with_invalid_string_periodic_interval(self):
        notification = helpers.create_notification(periodic_interval='random')
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          self.monasca_client.create_notifications,
                          notification)
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_create_email_notification_method_with_invalid_non_zero_periodic_interval(self):
        notification = helpers.create_notification(periodic_interval=1)
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          self.monasca_client.create_notifications,
                          notification)
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_create_pagerduty_notification_method_with_invalid_non_zero_periodic_interval(self):
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_create_webhook_notification_method_with_invalid_periodic_interval(self):
    ...
    def test_list_notification_methods(self):
        ...
        element = elements[0]
        self.assertTrue(set(['id', 'links', 'name', 'type', 'address', 'periodic_interval']) ==
                        set(element))
    ...
    def test_update_notification_method_name(self):
        ...
        resp, response_body = self.monasca_client.\
            update_notification_method(id, new_name,
                                       ...
                                       periodic_interval=response_body['periodic_interval'])
        self.assertEqual(200, resp.status)
    ...
    def test_update_notification_method_name_exceeds_max_length(self):
        ...
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          ...
                          address=response_body['address'], periodic_interval=response_body['periodic_interval'])
        resp, response_body = \
            self.monasca_client.delete_notification_method(id)
        self.assertEqual(204, resp.status)
    ...
    def test_update_notification_method_invalid_type(self):
        ...
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          ...
                          address=response_body['address'], periodic_interval=0)
        resp, response_body = \
            self.monasca_client.delete_notification_method(id)
        self.assertEqual(204, resp.status)
    ...
    def test_update_notification_method_address_exceeds_max_length(self):
        ...
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          ...
                          address=new_address_long, periodic_interval=response_body['periodic_interval'])
        resp, response_body = \
            self.monasca_client.delete_notification_method(id)
        self.assertEqual(204, resp.status)
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_update_email_notification_method_with_nonzero_periodic_interval(self):
        name = data_utils.rand_name('notification-')
        notification = helpers.create_notification(name=name)
        resp, response_body = self.monasca_client.create_notifications(
            notification)
        ...
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          self.monasca_client.update_notification_method, id,
                          name=response_body['name'], type=response_body['type'],
                          address=response_body['address'], periodic_interval=1)
        resp, response_body = \
            self.monasca_client.delete_notification_method(id)
        self.assertEqual(204, resp.status)
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_update_webhook_notification_method_to_email_with_nonzero_periodic_interval(self):
        name = data_utils.rand_name('notification-')
        notification = helpers.create_notification(name=name,
                                                   type='WEBHOOK',
                                                   address='http://localhost/test01',
        ...
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          ...
                          address='test@localhost', periodic_interval=response_body['periodic_interval'])
        resp, response_body = \
            self.monasca_client.delete_notification_method(id)
        self.assertEqual(204, resp.status)
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_update_webhook_notification_method_to_pagerduty_with_nonzero_periodic_interval(self):
        name = data_utils.rand_name('notification-')
        notification = helpers.create_notification(name=name,
                                                   type='WEBHOOK',
                                                   address='http://localhost/test01',
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_update_notification_method_with_non_int_periodic_interval(self):
        name = data_utils.rand_name('notification-')
        notification = helpers.create_notification(name=name)
        resp, response_body = self.monasca_client.create_notifications(
            notification)
        ...
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          self.monasca_client.update_notification_method, id,
                          name=response_body['name'], type=response_body['type'],
                          address=response_body['name'], periodic_interval='zero')
        resp, response_body = \
            self.monasca_client.delete_notification_method(id)
        self.assertEqual(204, resp.status)
    ...
    @test.attr(type="gate")
    @test.attr(type=['negative'])
    def test_update_webhook_notification_method_with_invalid_periodic_interval(self):
        name = data_utils.rand_name('notification-')
        notification = helpers.create_notification(name=name,
                                                   type='WEBHOOK',
                                                   address='http://localhost/test01',
        ...
        self.assertRaises((exceptions.BadRequest, exceptions.UnprocessableEntity),
                          self.monasca_client.update_notification_method, id,
                          name=response_body['name'], type=response_body['type'],
                          address=response_body['address'], periodic_interval=5)
        resp, response_body = \
            self.monasca_client.delete_notification_method(id)
        self.assertEqual(204, resp.status)
