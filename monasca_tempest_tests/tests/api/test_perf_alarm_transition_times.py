...
class TestPerfAlarmTransitionTimes(base.BaseMonascaTest):
    @classmethod
    def resource_setup(cls):
        super(TestPerfAlarmTransitionTimes, cls).resource_setup()

    @classmethod
    def resource_cleanup(cls):
        super(TestPerfAlarmTransitionTimes, cls).resource_cleanup()
