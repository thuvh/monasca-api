...
class TestAllAlarmsStateHistory(base.BaseMonascaTest):

    @classmethod
    def resource_setup(cls):
        super(TestAllAlarmsStateHistory, cls).resource_setup()
    ...
    def test_list_alarms_state_history_with_offset_limit(self):
        ...
        for index in xrange(len(elements) - 1):
            alarm_history = elements[index]
            max_limit = len(elements) - index
