...
dispatcher_opts = [cfg.StrOpt('versions', help='Versions'),
                   cfg.StrOpt('version_2_0', help='Version 2.0'),
                   cfg.StrOpt('metrics', help='Metrics'),
                   cfg.StrOpt('metrics_measurements', help='Metrics measurements'),
                   cfg.StrOpt('metrics_statistics', help='Metrics statistics'),
                   cfg.StrOpt('metrics_names', help='Metrics names'),
                   cfg.StrOpt('alarm_definitions', help='Alarm definitions'),
                   cfg.StrOpt('alarms', help='Alarms'),
                   cfg.StrOpt('alarms_count', help='Alarms Count'),
                   cfg.StrOpt('alarms_state_history', help='Alarms state history'),
                   cfg.StrOpt('notification_methods', help='Notification methods'),
                   cfg.StrOpt('dimension_values', help='Dimension values'),
