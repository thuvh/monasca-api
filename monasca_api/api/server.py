...
dispatcher_opts = [cfg.StrOpt('versions', default=None,
                   ...
                   cfg.StrOpt('alarm_inhibition_managers', default=None,
                              help='Alarm inhibition managers')]
...
def launch(conf, config_file="/etc/monasca/api-config.conf"):
    ...
    alarm_inhibition_managers = simport.load(
        cfg.CONF.dispatcher.alarm_inhibition_managers)()
    app.add_route("/v2.0/alarm-inhibition-managers/", alarm_inhibition_managers)
    app.add_route("/v2.0/alarm-inhibition-managers/{alarm_inhibition_manager_id}",
                  alarm_inhibition_managers)
