...
dispatcher_opts = [cfg.StrOpt('versions', default=None,
                   ...
                   cfg.StrOpt('alarm_silencing_managers', default=None,
                              help='Alarm silencing managers')]
...
def launch(conf, config_file="/etc/monasca/api-config.conf"):
    ...
    alarm_silencing_managers = simport.load(
        cfg.CONF.dispatcher.alarm_silencing_managers)()
    app.add_route("/v2.0/alarm-silencing-managers/", alarm_silencing_managers)
    app.add_route("/v2.0/alarm-silencing-managers/{"
                  "alarm_silencing_manager_id}", alarm_silencing_managers)
