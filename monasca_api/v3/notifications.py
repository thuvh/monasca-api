...
class Notifications(object):
    ...
    def _validate_notification(self, tenant_id, notification, require_all=False):
        """Validates the notification

        :param tenant_id: the tenant_id of the request
        ...
        self._validate_notification_method_type_exist(notification['notification_type'])
        self._validate_name_not_conflicting(tenant_id, notification['name'])
    ...
    def on_post(self, req, res):
        ...
        notification = utils.parse_http_json_body(req)
    ...
    def on_put(self, req, res, notification_method_id):
        ...
        self._validate_notification(req.tenant_id, notification, require_all=True)
