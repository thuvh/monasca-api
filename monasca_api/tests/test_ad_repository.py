...
class TestAlarmDefinitionRepoDB(testtools.TestCase, fixtures.TestWithFixtures):
    ...
    def setUp(self):
        ...
        from monasca_api.common.repositories.sql import alarm_definitions_repository as adr
    ...
    def test_should_update(self):
        ...
        ads = self.repo.get_alarm_definitions('bob', '90% CPU', {'image_id': '888'}, None, 0, 100)
        expected = [{'actions_enabled': False,
                     'alarm_actions': '29387234,77778687',
                     'description': None,
                     'expression': 'AVG(hpcs.compute{flavor_id=777, '
