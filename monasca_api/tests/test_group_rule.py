...
class GroupRuleDefinitionTestBase(AlarmTestBase):
    def __init__(self):
        self.group_rule_repo_mock = None
        self.group_rule_resource = None
    ...
    def test_group_rule_create(self):
        ...
        group_rule = {
            ...
            "expression": "alarm_name"
        }

        expected_data = {
            u"name": u"test_group_rule",
            u"description": u'',
            u"expression": u'alarm_name',
            u"group_wait": u"30s",
    ...
    def test_group_rule_create_with_optional_params(self):
        ...
        group_rule = {
            ...
            "expression": "alarmName and metricName",
            "group_wait": "2m",
            "repeat_interval": "60s"
        }
        ...
        expected_data = {
            ...
            u"expression": u'alarmName and metricName',
            u"group_wait": u"2m",
    ...
    def test_group_rule_create_with_similar_actions(self):
        return_value = self.group_rule_repo_mock.return_value
        return_value.get_group_rules.return_value = []
        return_value.create_group_rule.return_value = \
            u"00000001-0001-0001-0001-000000000001"
    ...
    def test_group_rule_update(self):
        ...
        self.group_rule_repo_mock.return_value.update_or_patch_group_rule.return_value = (
            {u'alarm_actions': "123abc",
             u'ok_actions': "123abc",
             u'id': u'00000001-0001-0001-0001-000000000001',
             u'name': u'Test Alarm',
             u'description': 'test group rule',
             u'undetermined_actions': "123abc",
             u"expression": u'alarmName and metricName',
             u'group_wait': u'30s',
             u'repeat_interval': u'2h'
             }
    ...
    def test_group_rule_patch(self):
        ...
        expression = u'alarmName and metricName'
        group_wait = u"1m"
        ...
        expected_rule = {
            ...
            u'links': [{u'href': u'http://falconframework.org/v2.0/group-rules/'
                        ...
                        u'rel': u'self'}],
            u'name': new_name,
            u'description': u'test_group_rule',
            u'undetermined_actions': [],
    ...
    def test_get_alarm_definitions_with_multibyte_character(self):
        ...
        if six.PY2:
            rule_name = def_name.decode('utf8')
        self.group_rule_repo_mock.return_value.get_group_rule.return_value = {
            u'alarm_actions': None,
            u'ok_actions': None,
            u'id': u'00000001-0001-0001-0001-000000000001',
