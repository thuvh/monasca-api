...
class TestMetricsDbHealthCheck(base.BaseTestCase):
    ...
    def test_health_check(self, simport_mock):
        metrics_repo_mock = simport_mock.load.return_value.return_value
    ...
    def test_health_check_load_failed(self, simport_mock):
        simport_mock.load.side_effect = Exception()
        self.assertRaises(falcon.HTTPInternalServerError, tdc.MetricsDbCheck)
