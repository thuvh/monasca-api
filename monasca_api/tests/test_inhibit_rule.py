...
class InhibitRuleTestBase(TestBase):
    ...
    def setUp(self):
        ...
        self._send_rule_event = self.inhibit_rule_resource.send_event
    ...
    def test_inhibit_rule_create(self):
        ...
        ((_, event), _) = self._send_rule_event.call_args
    ...
    def test_inhibit_rule_update_no_id(self):
        inhibit_rule = {
            "name": "test_inhibit_rule_update_no_id",
            "description": "test update with no id",
            "expression": "source metric_1 targets metric_2 excluding metric_3"
        }
        self.simulate_request("/v2.0/inhibit-rules",
    ...
    def test_inhibit_rule_patch_no_id(self):
        inhibit_rule = {
            "name": "test_inhibit_rule_patch_no_id",
            "expression": "source metric_1 targets metric_2 excluding metric_3"
        }
        self.simulate_request("/v2.0/inhibit-rules",
                              headers={'X-Roles': 'admin',
    ...
    def test_inhibit_rule_delete_no_id(self):
        self.simulate_request("/v2.0/inhibit-rules",
                              headers={'X-Roles': 'admin',
                                       'X-Tenant-Id': TENANT_ID},
                              method="DELETE")
