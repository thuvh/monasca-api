...
class TestRepoMetricsCassandra(base.BaseTestCase):
    ...
    def test_init(self, cassandra_connect_mock):
        ...
        self.assertIsNone(repo.cluster.auth_provider,
        ...
        repo = cassandra_repo.MetricsRepository()
        self.assertIsInstance(repo.cluster.auth_provider, PlainTextAuthProvider,
                             'cassandra cluster auth provider is not expected to None')
