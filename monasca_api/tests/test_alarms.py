...
class TestAlarmDefinition(AlarmTestBase):
    ...
    def test_alarm_definition_create(self):
        ...
        self.alarm_def_repo_mock.return_value.create_alarm_definition.return_value = u"00000001-0001-0001-0001-000000000001"
    ...
    def test_alarm_definition_update(self):
        ...
        self.simulate_request("/v2.0/alarm-definitions/%s" % expected_data[u'id'],
                              headers={'X-Roles': 'admin', 'X-Tenant-Id': TENANT_ID},
                              method="PUT",
                              body=json.dumps(alarm_def))
    ...
    def test_alarm_definition_update_missing_fields(self):
        ...
        def_id = u'00000001-0001-0001-0001-000000000001'
        ...
        self.simulate_request("/v2.0/alarm-definitions/%s" % def_id,
                              headers={'X-Roles': 'admin', 'X-Tenant-Id': TENANT_ID},
                              method="PUT",
                              body=json.dumps(alarm_def))
