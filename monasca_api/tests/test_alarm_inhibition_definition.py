...
class MonascaApiConfigFixture(oslo_config.fixture.Config):
    ...
    def setUp(self):
        ...
        self.conf.set_override(
            ...
            'monasca_api.common.repositories.alarm_inhibition_definitions_repository:AlarmInhibitionDefinitionsRepository',
...
class InhibitionRuleDefinitionTestBase(AlarmTestBase):
    ...
    def test_inhibition_rule_definition_update(self):
        ...
        expected_def = {
            ...
            u'source_match': [u'severity=CRITICAL'],
            u'target_match': [u'severity=LOW']
        }
