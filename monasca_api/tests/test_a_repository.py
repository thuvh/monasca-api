...
class TestAlarmRepoDB(testtools.TestCase, fixtures.TestWithFixtures):
    ...
    def setUpClass(cls):
        ...
        def _fake_engine_from_config(configuration, prefix, **kw):
            return cls.engine
    ...
    def setUp(self):
        ...
        cfg.CONF.register_opt(cfg.StrOpt('url',
                                         default=''),
                              group='database')
        ...
        from monasca_api.common.repositories.sql \
            import alarms_repository as ar
    ...
    def test_should_find(self):
        ...
        query_parms = {'metric_name': 'cpu.idle_perc',
                       'metric_dimensions':
                       'service:monitoring,hostname:roland'}
        res = self.repo.get_alarms(tenant_id=tenant_id,
                                   query_parms=query_parms,
                                   limit=1000)
        res = self.helper_builder_result(res)
    ...
    def test_should_update(self):
        ...
        prev_state = self.repo.update_alarm(tenant_id, alarm_id, 'OK', None, None)
        ...
        self.assertEqual(alarm['state'], prev_state)
        ...
        self.assertEqual(alarm_new['state'], prev_state)
