...
class TestNotificationValidation(unittest.TestCase):
    ...
    def test_validation_exception_for_invalid_email_address(self):
        ...
        with self.assertRaises(schemas_exceptions.ValidationException) as ve:
            schemas_notifications.parse_and_validate(notification, valid_periods)
        ex = ve.exception
        self.assertEqual("Address name@ is not of correct format", six.text_type(ex))
    ...
    def test_validation_exception_for_invalid_period_for_email(self):
        ...
        with self.assertRaises(schemas_exceptions.ValidationException) as ve:
            schemas_notifications.parse_and_validate(notification, valid_periods)
        ex = ve.exception
        self.assertEqual("Period can only be set with webhooks", six.text_type(ex))
    ...
    def test_validation_exception_for_webhook_no_scheme(self):
        ...
        with self.assertRaises(schemas_exceptions.ValidationException) as ve:
            schemas_notifications.parse_and_validate(notification, valid_periods)
        ex = ve.exception
        self.assertEqual("Address //somedomain.com does not have URL scheme", six.text_type(ex))
    ...
    def test_validation_exception_for_webhook_no_netloc(self):
        ...
        with self.assertRaises(schemas_exceptions.ValidationException) as ve:
            schemas_notifications.parse_and_validate(notification, valid_periods)
        ex = ve.exception
        self.assertEqual("Address http:// does not have network location", six.text_type(ex))
    ...
    def test_validation_exception_for_webhook_invalid_scheme(self):
        ...
        with self.assertRaises(schemas_exceptions.ValidationException) as ve:
            schemas_notifications.parse_and_validate(notification, valid_periods)
        ex = ve.exception
        self.assertEqual("Address ftp://somedomain.com scheme is not in ['http', 'https']", six.text_type(ex))
    ...
    def test_validation_exception_for_webhook_invalid_period(self):
        ...
        with self.assertRaises(schemas_exceptions.ValidationException) as ve:
            schemas_notifications.parse_and_validate(notification, valid_periods)
        ex = ve.exception
        self.assertEqual("10 is not a valid period", six.text_type(ex))
    ...
    def test_validation_exception_for_invalid_period_float(self):
        ...
        with self.assertRaises(schemas_exceptions.ValidationException) as ve:
            schemas_notifications.parse_and_validate(notification, valid_periods)
        ex = ve.exception
        self.assertEqual("expected int for dictionary value @ data['period']", six.text_type(ex))
    ...
    def test_validation_exception_for_invalid_period_non_int(self):
        ...
        with self.assertRaises(schemas_exceptions.ValidationException) as ve:
            schemas_notifications.parse_and_validate(notification, valid_periods)
        ex = ve.exception
        self.assertEqual("Period zero must be a valid integer", six.text_type(ex))
    ...
    def test_validation_exception_for_missing_period(self):
        ...
        ex = ve.exception
        self.assertEqual("Period is required", six.text_type(ex))
