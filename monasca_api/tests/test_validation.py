...
class TestDimensionValidation(unittest.TestCase):
    ...
    def test_nonstring_value(self):
        dim_value = None
        self.assertRaises(TypeError, validation.dimension_value, dim_value)
    ...
    def test_value_parsing_string(self):
        value = "test_string"
        returned_value = validation.parse_and_validate_dimension_value(value)
        self.assertEqual(returned_value, value)

    def test_value_parsing_nonstring(self):
        value = 44
        returned_value = validation.parse_and_validate_dimension_value(value)
        self.assertTrue(isinstance(returned_value, (str, unicode)))
        self.assertEqual(returned_value, str(value))
