...
class RegisteredPoliciesTestCase(base.BaseTestCase):
    def __init__(self, *args, **kwds):
        ...
        self.default_roles = [
            'admin', 'domainuser', 'domainadmin', 'monasca-user'
        ]
    ...
    def test_alarms_policies_roles(self):
        alarms_policies = {
            ...
            'api:alarms:definition:get:none_id': self.default_roles,
    ...
    def test_metrics_policies_roles(self):
        metrics_policies = {
            ...
            'api:metrics:post': self.agent_roles,
    ...
    def test_notifications_policies_roles(self):
        notifications_policies = {
            ...
            'api:notifications:type': ['any_rule']
