...
class TestNotifications(base.BaseApiTestCase):
    ...
    def test_create_notifications(self):
        ...
        self.simulate_request('/v2.0/notification-methods',
                              headers={'X-Roles':
    ...
    def test_delete_notification(self):
        self.simulate_request('/v2.0/notification-methods/1',
                              headers={'X-Roles':
                                       CONF.security.default_authorized_roles[0],
                                       'X-Tenant-Id': TENANT_ID},
                              method='DELETE')
...
class TestNotificationsType(base.BaseApiTestCase):
    ...
    def test_get_notification_types(self):
        ...
        response = self.simulate_request('/v2.0/notification-methods/types',
                                         headers={'X-Roles':
                                                  CONF.security.default_authorized_roles[0],
                                                  'X-Tenant-Id': TENANT_ID,
                                                  'Content-Type': 'application/json'},
