...
def upgrade():
    alarm_state = op.create_table(
            'alarm_state',
            sa.Column('name', type=sa.String(length=20),
    ...
    notification_method = op.create_table(
            ...
            sa.Column('id', sa.String(length=36),
                      primary_key=True, nullabe=False),
    ...
    op.create_table(
            'metric_definition',
            sa.Column('id', sa.Binary(), primary_key=True, nullabe=False),
            sa.Column('name', sa.String(255), nullabe=False),
            sa.Column('tenant_id', sa.String(255), nullabe=False),
            sa.Column('region', sa.String(255), nullabe=False))

    op.create_table(
            'metric_definition_dimensions',
            sa.Column('id', sa.Binary(), nullabe=False),
    ...
    op.create_table(
            ...
            sa.Column('dimension_set_id', sa.Binary(),
                      index=True, nullabe=False),
            sa.Column('name', sa.String(255), nullabe=False),
            sa.Column('value', sa.String(255), nullabe=False),
