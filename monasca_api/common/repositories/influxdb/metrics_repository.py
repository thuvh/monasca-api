...
class MetricsRepository(metrics_repository.AbstractMetricsRepository):
    ...
    def _init_serie_builders(self):
        ...
        try:
            ...
            LOG.exception(ex)
            # Initialize the serie builders to v0_11_0. Not sure when SHOW
            # DIAGNOSTICS added support for a version string so to address
            # backward compatibility initialize InfluxDB serie builders <
            # v0.11.0
            self._init_serie_builders_to_v0_11_0()
