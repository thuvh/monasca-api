...
class MetricsRepository(metrics_repository.MetricsRepository):
    ...
    def _validate_not_multiple_metrics(self, tenant_id, region, name, dimensions, merge_metrics_flag):
    ...
    def measurement_list(self, tenant_id, region, name, dimensions,
        ...
        try:
            self._validate_not_multiple_metrics(tenant_id, region, name, dimensions, merge_metrics_flag)
