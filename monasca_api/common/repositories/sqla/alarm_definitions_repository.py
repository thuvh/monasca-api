        ...
        with self._db_engine.connect() as conn:
            ...
            if dimensions:
                ...
                for n, v in dimensions.items():
                    ...
                    parms[bind_dimension_name] = n if six.PY2 else n.encode('utf8')
                    parms[bind_value] = v if six.PY2 else v.encode('utf8')
    ...
    def update_or_patch_alarm_definition(self, tenant_id, alarm_definition_id,
        ...
        with self._db_engine.begin() as conn:
            ...
            if match_by is None:
                ...
                metch_str = ",".join(match_by)
                new_match_by = metch_str.encode('utf8') if six.PY2 else metch_str
        ...
        for action in actions:
            ...
            if row is None:
                raise exceptions.InvalidUpdateException(
                    ...
                    "notification action".format(strtext(action.encode('utf8')),
                                                 strtext(alarm_state.encode('utf8'))))
