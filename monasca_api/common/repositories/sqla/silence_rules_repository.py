...
class SilenceRulesRepository(sql_repository.SQLRepository,
    ...
    def __init__(self):
        ...
        self.update_sr_query = (
            ...
            .where(sr.c.rule_id == bindparam('b_rule_id')))
    ...
    @sql_repository.sql_try_catch_block
    def get_silence_rules(self, tenant_id, name=None, offset=None, limit=1000):
        with self._db_engine.connect() as conn:
            ...
            if name:
                query = query.where(srs.c.name == bindparam('b_name'))
    ...
    @sql_repository.sql_try_catch_block
    def get_silence_rule(self, tenant_id, _id):
        with self._db_engine.connect() as conn:
            return self._get_silence_rule(conn, tenant_id, _id)
    ...
    def update_or_patch_silence_rule(
        ...
        with self._db_engine.begin() as conn:
            ...
            query = (self.base_query
                     .where(srs.c.tenant_id == bindparam('b_tenant_id'))
                     .where(srs.c.rule_id == bindparam('b_rule_id'))
                     .where(srs.c.deleted_at == null()))
    ...
    def _get_silence_rule(self, conn, tenant_id, _id):
        ard = self.ard
        query = (self.base_query
                 .select_from(self.base_query_from)
                 .where(ard.c.tenant_id == bindparam('b_tenant_id'))
                 .where(ard.c.rule_id == bindparam('b_rule_id'))
