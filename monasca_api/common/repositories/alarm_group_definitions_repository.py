...
class AlarmGroupDefinitionsRepository(object):
    def __init__(self):
    ...
    @abc.abstractmethod
    def get_alarm_group_definitions(self, tenant_id, name, offset, limit):
        pass

    @abc.abstractmethod
    def get_alarm_group_definition(self, tenant_id, alarm_group_definition_id):
        pass
