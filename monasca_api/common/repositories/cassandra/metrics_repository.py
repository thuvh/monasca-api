...
class MetricsRepository(metrics_repository.AbstractMetricsRepository):
    def __init__(self):
        ...
        try:
            ...
            contact_points = [ip for ip in self.conf.cassandra.contact_points]
            self.cluster = Cluster(contact_points, port=self.conf.cassandra.port, auth_provider=auth_provider)
