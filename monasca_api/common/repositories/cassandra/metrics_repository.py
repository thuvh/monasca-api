    ...
    def build_dimensions_clause(self, dimensions, parms):
        ...
        if dimensions:
            ...
            for name, value in dimensions.iteritems():
                dimension_clause += ' and metric_set contains %s '
        ...
        try:
            ...
            for (time_stamp, value, value_meta) in rows:
                ...
                if (time_stamp - start_period).seconds > period:
                    ...
                    stat = [
                        start_period.strftime('%Y-%m-%dT%H:%M:%S.%fZ').decode(
                            'utf8')]
            ...
            if count:
                ...
                stat = [start_period.strftime('%Y-%m-%dT%H:%M:%S.%fZ').decode(
                    'utf8')]
