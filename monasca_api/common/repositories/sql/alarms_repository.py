...
from sqlalchemy import MetaData, update, delete, select, text, bindparam, func
...
class AlarmsRepository(sql_repository.SQLRepository,
    ...
    def get_alarms(self, tenant_id, query_parms={}, offset=None, limit=None):
        ...
        with self._db_engine.connect() as conn:
            ...
            if offset:
                query = query.where(ad.c.id > bindparam('b_offset'))
            ...
            if 'alarm_definition_id' in query_parms:
                ...
                parms['b_alarm_definition_id'] =\
                    query_parms['alarm_definition_id']
            ...
            if 'metric_dimensions' in query_parms:
                ...
                query_splitted = query_parms['metric_dimensions'].split(',')
                for i, metric_dimension in enumerate(query_splitted):
