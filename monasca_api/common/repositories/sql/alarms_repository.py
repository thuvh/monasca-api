            ...
            if 'group_by' in query_parms:
                ...
                if metric_group_by:
                    ...
                    if 'metric_name' in metric_group_by:
                        group_by_columns.append(mde.c.name.label('metric_name'))
                    if 'dimension_name' in metric_group_by:
                        group_by_columns.append(md.c.name.label('dimension_name'))
                    if 'dimension_value' in metric_group_by:
                        group_by_columns.append(md.c.value.label('dimension_value'))
