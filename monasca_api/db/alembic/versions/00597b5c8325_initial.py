...
"""Initial migration for complete database schema (Git revision 00597b5c8325664c2c534625525f59232d243d66).
...
def downgrade():
    op.delete_table('alarm_state')
    op.delete_table('alarm_definition_severity')
    op.delete_table('notification_method_type')
    op.delete_table('stream_actions_action_type')
    op.delete_table('alarm')
    op.delete_table('alarm_action')
    op.delete_table('alarm_definition')
    op.delete_table('alarm_metric')
    op.delete_table('metric_definition')
    op.delete_table('metric_definition_dimensions')
    op.delete_table('metric_dimension')
    op.delete_table('notification_method')
    op.delete_table('sub_alarm_definition')
    op.delete_table('sub_alarm_definition_dimension')
    op.delete_table('sub_alarm')
    op.delete_table('schema_migrations')
    op.delete_table('stream_actions')
    op.delete_table('stream_definition')
    op.delete_table('event_transform')
