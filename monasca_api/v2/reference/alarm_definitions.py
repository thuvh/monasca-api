...
class AlarmDefinitions(alarm_definitions_api_v2.AlarmDefinitionsV2API,
    ...
    def _find_existing_alarm_definition(self, tenant_id, name, expected_id=None):
    ...
    def _alarm_definition_update_or_patch(self, tenant_id,
        ...
        self._find_existing_alarm_definition(tenant_id, name, expected_id=definition_id)
    ...
    def _alarm_definition_create(self, tenant_id, name, expression,
        ...
        self._find_existing_alarm_definition(tenant_id, name)
