...
repositories_opts = [
    ...
    cfg.StrOpt('notification_method_type_driver',
               ...
               help='The repository driver to use for notifications'),
    cfg.StrOpt('alarm_inhibition_managers_driver',
               default=base_sqla_path + 'alarm_inhibition_managers_repository:AlarmInhibitionManagersRepository',
               help='The repository driver to use for alarm inhibition managers')]
