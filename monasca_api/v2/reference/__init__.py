...
repositories_opts = [
    ...
    cfg.StrOpt('notification_method_type_driver',
               ...
               help='The repository driver to use for notifications'),
    cfg.StrOpt('alarm_silencing_managers_driver',
               default=base_sqla_path + 'alarm_silencing_managers_repository:AlarmSilencingManagersRepository',
               help='The repository driver to use for alarm silencing managers'
               )]
