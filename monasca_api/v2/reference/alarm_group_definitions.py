...
class AlarmGroupDefinitions(alarm_group_definitions_api_v2.
    ...
    def on_post(self, req, res):
        ...
        exclusions = get_query_alarm_group_definition_exclusions(
            alarm_group_definition)
        alarm_actions = get_query_alarm_definition_actions(
            alarm_group_definition, "alarm_actions")
        ok_actions = get_query_alarm_definition_actions(
            alarm_group_definition, "ok_actions")
        undetermined_actions = get_query_alarm_definition_actions(
...
def get_query_alarm_definition_actions(alarm_group_definition, action_state,
                                       return_none=False):
