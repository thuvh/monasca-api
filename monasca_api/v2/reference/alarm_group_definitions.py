...
class AlarmGroupDefinitions(alarm_group_definitions_api_v2.
    ...
    def on_post(self, req, res):
        ...
        alarm_group_definition = helpers.from_json(req)
        ...
        name = get_query_alarm_group_definition_param(alarm_group_definition,
                                                      "name")
        description = get_query_alarm_group_definition_description(
    ...
    def on_get(self, req, res, alarm_group_definition_id=None):
        ...
        if not alarm_group_definition_id:
    ...
    def on_put(self, req, res, alarm_group_definition_id):
        ...
        result = self._alarm_group_definition_update_or_patch(
            req.project_id, alarm_group_definition_id, name, description,
    ...
    @resource.resource_try_catch_block
    def _alarm_group_definition_create(self, tenant_id, name, description,
        ...
        alarm_group_definition_id = (
            self._alarm_group_definitions_repo
                .create_alarm_group_definition(tenant_id, name, description,
                                               matchers, group_wait,
                                               repeat_interval, exclusions,
    ...
    def _build_alarm_group_definition_show_result(
        ...
        exclusions = get_comma_seperated_str_as_dict(
            alarm_group_definition_row['exclusions'])
        group_wait = (alarm_group_definition_row['group_wait']
                      if alarm_group_definition_row['group_wait']
                      else '30s')
        repeat_interval = (alarm_group_definition_row['repeat_interval']
                           if alarm_group_definition_row['repeat_interval']
                           else '2h')
        description = (alarm_group_definition_row['description']
                       if alarm_group_definition_row['description']
                       else '')
        ...
        result = {
            ...
            u'matchers': matchers,
            u'exclusions': exclusions,
            u'id': alarm_group_definition_row['id'],
    ...
    def _alarm_group_definition_list(self, tenant_id, name, req_uri, offset,
        ...
        for alarm_group_definition_row in alarm_group_definition_rows:
            ...
            agd = {u'id': alarm_group_definition_row['id'],
                   u'name': alarm_group_definition_row['name'],
                   u'description': alarm_group_definition_row['description']
                   if (alarm_group_definition_row['description']) else u'',
                   u'matchers': matchers,
...
def get_query_alarm_group_definition_description(alarm_group_definition,
                                                 return_none=False):
    if 'description' in alarm_group_definition:
        return alarm_group_definition['description']
    else:
        if return_none:
            return None
        else:
...
def get_comma_seperated_str_as_dict(comma_separated_str):
    if not comma_separated_str:
        return {}
    else:
