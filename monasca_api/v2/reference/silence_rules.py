...
class SilenceRules(silence_rules_api_v2.SilenceRulesV2API, alarming.Alarming):
    ...
    def on_post(self, req, res):
        ...
        result = self._silence_rule_create(req.project_id, name, description, expression,
    ...
    @resource.resource_try_catch_block
    def on_put(self, req, res, silence_rule_id):
        ...
        result = self._silence_rule_update_or_patch(
            req.project_id, silence_rule_id, name, description,
            expression, start_time, silence_duration, patch=False)
    ...
    @resource.resource_try_catch_block
    def on_patch(self, req, res, silence_rule_id):
        ...
        result = self._silence_rule_update_or_patch(
            req.project_id, silence_rule_id, name, description,
            expression, start_time, silence_duration, patch=True)
    ...
    def _silence_rule_update_or_patch(
            self, tenant_id, silence_rule_id, name, description,
            expression, start_time, silence_duration, patch):
        if name:
    ...
    @resource.resource_try_catch_block
    def _silence_rule_create(self, tenant_id, name, description, expression,
                             start_time, silence_duration):
        self._validate_name_not_conflicting(tenant_id, name)

        silence_rule_id = (
            self._silence_rules_repo
                .create_silence_rule(tenant_id, name, description, expression,
                                     start_time, silence_duration))
    ...
    def _silence_rule_list(self, tenant_id, name, req_uri, offset, limit):
        ...
        for silence_rule_row in silence_rule_rows:
            ...
            asm = {u'id': silence_rule_row['id'],
                   ...
                   u'silence_duration': silence_rule_row[
                       'silence_duration']
...
def get_query_silence_rule_param(
        silence_rule, param, return_none=False):
    try:
