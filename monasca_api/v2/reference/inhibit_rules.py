...
class InhibitRules(inhibit_rules_api_v2.InhibitRulesV2API, alarming.Alarming):
    ...
    def _inhibit_rule_update_or_patch(self, tenant_id, inhibit_rule_id, name,
        ...
        inhibit_rule_event_dict = (
            {u'tenantId': tenant_id,
             ...
             u'source': result_expression['source_match'],
             u'target': result_expression['target_match'],
             u'equals': result_expression['equal'],
    ...
    def _send_inhibit_rule_created_event(self, tenant_id, inhibit_rule_id,
                                         name, expression):
        result_expression = aql_parser.RuleExpressionParser(expression).parse()
