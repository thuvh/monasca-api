...
from monasca_api.common.messaging.message_formats import metrics as\
    metrics_message
from monasca_api.openstack.common import log
from monasca_api.v2.reference import helpers, resource
...
def get_boolean_merge_metrics_flag(merge_metrics_flag_str):
...
class MetricsMeasurements(metrics_api_v2.MetricsMeasurementsV2API):
    ...
    def on_get(self, req, res):
        ...
        merge_metrics_flag = helpers.get_query_param(req, 'merge_metrics',
                                                     ...
                                                     False)
        merge_metrics_flag = (
            get_boolean_merge_metrics_flag(merge_metrics_flag))
