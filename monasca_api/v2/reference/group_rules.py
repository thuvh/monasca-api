...
class GroupRules(group_rules_api_v2.GroupRulesV2API):
    ...
    def send_rule_event(self, message_queue, event_msg):
        try:
    ...
    def _group_rule_update_or_patch(
        ...
        self.send_rule_event(self.rule_updates_message_queue, group_rule_updated_event)
        return result
    ...
    def _send_group_rule_created_event(self, tenant_id, group_rule_id, name,
        ...
        self.send_rule_event(self.rule_updates__message_queue,
                             group_rule_created_event_msg)
