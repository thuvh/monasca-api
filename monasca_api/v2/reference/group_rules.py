...
class GroupRules(group_rules_api_v2.GroupRulesV2API, alarming.Alarming):
    ...
    @resource.resource_try_catch_block
    def on_put(self, req, res, group_rule_id=None):
        if not group_rule_id:
            raise HTTPBadRequestError('Bad Request',
                                      'Group rule id is not provided')
        helpers.validate_authorization(req, self._default_authorized_roles)
    ...
    @resource.resource_try_catch_block
    def on_patch(self, req, res, group_rule_id=None):
        if not group_rule_id:
            raise HTTPBadRequestError('Bad Request',
                                      'Group rule id is not provided')
        helpers.validate_authorization(req, self._default_authorized_roles)
    ...
    @resource.resource_try_catch_block
    def on_delete(self, req, res, group_rule_id=None):
        if not group_rule_id:
            raise HTTPBadRequestError('Bad Request',
                                      'Group rule id is not provided')
        helpers.validate_authorization(req, self._default_authorized_roles)
    ...
    def _build_group_rule_show_result(self, group_rule_row):
        ...
        description = (group_rule_row['description']
                       ...
                       else constants.GROUP_RULE_DESCRIPTION)
