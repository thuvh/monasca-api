...
group_rule_schema = {
    voluptuous.Required('name'): voluptuous.All(
        voluptuous.Any(str, six.string_types), voluptuous.Length(max=255)),
    voluptuous.Required('expression'): voluptuous.All(
        voluptuous.Any(str, six.string_types), voluptuous.Length(max=1024)),
    voluptuous.Marker('description'): voluptuous.All(
        voluptuous.Any(str, six.string_types), voluptuous.Length(max=255)),
    voluptuous.Marker('group_wait'): voluptuous.Any(str, six.string_types),
    voluptuous.Marker('repeat_interval'): voluptuous.Any(str, six.string_types),
