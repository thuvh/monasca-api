...
Requires [monasca-common] (https://git.openstack.org/openstack/monasca-common). First clone this repository and then do mvn install. Then return to monasca-api and:
