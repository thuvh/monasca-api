...
public class AlarmResource {
  ...
  @Timed
  @Produces(MediaType.APPLICATION_JSON)
  @ApiOperation(value = "Get alarms", response = Alarm.class, responseContainer = "List")
  public List<Alarm> getAlarms(@Context UriInfo uriInfo,
    ...
    return Links.hydrate(repo.find(tenantId, alarmDefId, metricName, metricDimensions, state), uriInfo);
  }
