...
public class NotificationMethodResourceTest extends AbstractMonApiResourceTest {
  private NotificationMethod notificationMethod, notificationMethodEndPoint;
  ...
  protected void setupResources() throws Exception {
    ...
    notificationMethodEndPoint =
        new NotificationMethod("1234", "MyEp", NotificationMethodType.ENDPOINT, "http://localhost");
    ...
    when(repo.create(eq("abc"), eq("MyEP"), eq(NotificationMethodType.ENDPOINT), anyString()))
        .thenReturn(notificationMethodEndPoint);
    ...
    public void shouldCreateEndpointNotification() {
        ClientResponse response =
                client()
                        ...
                        .header("Content-Type", MediaType.APPLICATION_JSON)
                        .post(ClientResponse.class,
                                new CreateNotificationMethodCommand("MyEP", NotificationMethodType.ENDPOINT,
                                        "http://localhost"));
