...
public class CreateNotificationMethodTest extends AbstractModelTest {
  ...
  public void shouldDeserializeFromJsonDefinedPeriodicInterval() throws Exception {
    CreateNotificationMethodCommand newNotificationMethod =
            new CreateNotificationMethodCommand("MyWebhook", NotificationMethodType.WEBHOOK, "http://somedomain.com", "1");

    String json = jsonFixture("fixtures/newNotificationMethodWithPeriodicInterval.json");
    CreateNotificationMethodCommand other = fromJson(json, CreateNotificationMethodCommand.class);
    assertEquals(other, newNotificationMethod);
  }
  ...
  @Test(expectedExceptions = WebApplicationException.class)
  public void testValidationExceptionForNonZeroPeriodicIntervalForEmail() {
    CreateNotificationMethodCommand newNotificationMethod =
            new CreateNotificationMethodCommand("MyEmail", NotificationMethodType.EMAIL, "name@domain.", "1");
    newNotificationMethod.validate();
  }
  ...
  public void testValidationNonZeroPeriodicIntervalForWebhook() {
    CreateNotificationMethodCommand newNotificationMethod =
            new CreateNotificationMethodCommand("MyWebhook", NotificationMethodType.WEBHOOK, "http://somedomain.com", "1");
    newNotificationMethod.validate();
  }
  ...
  @Test(expectedExceptions = WebApplicationException.class)
  public void testValidationExceptionForNonZeroPeriodicIntervalForPagerDuty() {
    CreateNotificationMethodCommand newNotificationMethod =
            new CreateNotificationMethodCommand("MyPagerduty", NotificationMethodType.PAGERDUTY, "nzH2LVRdMzun11HNC2oD", "1");
    newNotificationMethod.validate();
  }
  ...
  @Test(expectedExceptions = WebApplicationException.class)
  public void testValidationExceptionForNonIntPeriodicInterval() {
    CreateNotificationMethodCommand newNotificationMethod =
  ...
  @Test(expectedExceptions = WebApplicationException.class)
  public void testValidationExceptionForInvalidPeriodicInterval() {
    CreateNotificationMethodCommand newNotificationMethod =
