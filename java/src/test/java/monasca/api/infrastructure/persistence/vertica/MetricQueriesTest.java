...
public class MetricQueriesTest {
  ...
  public void metricQueriesBuildDimensionAndClauseTest1() {
    String expectedResult =
        " and ( (defdims.name = :dname0 and defdims.value = :dvalue0)"
        + " or (defdims.name = :dname1 and defdims.value = :dvalue1))";
  ...
  public void metricQueriesBuildDimensionAndClauseTest4() {
    String expectedResult =
        " and ( (defdims.name = :dname0 and ( defdims.value = :dvalue0_0 or defdims.value = :dvalue0_1)))";
  ...
  public void metricQueriesBuildDimensionAndClauseTest5() {
    String expectedResult =
        " and ( (defdims.name = :dname0 and ( defdims.value = :dvalue0_0 or defdims.value = :dvalue0_1))"
        + " or (defdims.name = :dname1 and ( defdims.value = :dvalue1_0 or defdims.value = :dvalue1_1)))";
