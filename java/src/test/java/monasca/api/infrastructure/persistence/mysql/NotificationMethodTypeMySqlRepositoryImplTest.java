...
public class NotificationMethodTypeMySqlRepositoryImplTest {
  ...
  protected void beforeMethod() {
    ...
    create_notification_method_types();
  }


  private void  create_notification_method_types() {
  ...
  public void shouldListNotificationMethodTypes() {
       List<String>  notification_method_types = repo.list_notification_method_types();
