...
public class NotificationMethodSqlRepositoryImplTest {
  ...
  protected void setupClass() throws Exception {
    ...
    repo = new NotificationMethodSqlRepoImpl(sessionFactory);
  }
  ...
  protected void beforeMethod() {
    ...
    try {
      ...
      session.createSQLQuery("truncate table notification_method").executeUpdate();
  ...
  public void shouldFind() {
    ...
    assertEquals(nms2, Arrays.asList(new NotificationMethod("124", "OtherEmail", NotificationMethodType.EMAIL, "a@b")));
  }
