...
public class AlarmSqlRepositoryImplTest {
  ...
  public void shouldFind() {
    ...
    checkUnsortedList(repo.find(TENANT_ID, null, null, null, null, null, null, null, null, null, null, 2, true), alarm1, alarm2, compoundAlarm);
    checkUnsortedList(repo.find(TENANT_ID, null, null, null, null, null, null, null, null, null, "1", 1, true), alarm2, compoundAlarm);
    checkUnsortedList(repo.find(TENANT_ID, null, null, null, null, null, null, null, null, null, "2", 1, true), compoundAlarm, alarm3);
    checkUnsortedList(repo.find(TENANT_ID, null, null, null, null, null, null, null, null, null, "3", 1, true), alarm3);
...
//        compoundAlarm);
  ...
  public void shouldFilterBySeverity() {
    checkUnsortedList(repo.find(TENANT_ID, null, null, null, null, AlarmSeverity.LOW, null, null, null, null, null, 1, false),
        alarm1, alarm2, alarm3);

    checkUnsortedList(repo.find(TENANT_ID, null, null, null, null, AlarmSeverity.HIGH, null, null, null, null, null, 1, false),
        compoundAlarm);

    // no alarms for those severities
    checkUnsortedList(repo.find(TENANT_ID, null, null, null, null, AlarmSeverity.CRITICAL, null, null, null, null, null, 1, false));
    checkUnsortedList(repo.find(TENANT_ID, null, null, null, null, AlarmSeverity.MEDIUM, null, null, null, null, null, 1, false));
  }
