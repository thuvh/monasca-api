...
public class DimensionResource {
      ...
      @QueryParam("tenant_id") String crossTenantId) throws Exception
  {
    ...
    DimensionValues dimValues = repo.findValues(metricName, queryTenantId, dimensionName, offset, paging_limit);
    return Links.paginateDimensionNamesOrValues(dimValues, paging_limit, uriInfo);
  }
          ...
          @QueryParam("tenant_id") String crossTenantId) throws Exception
  {
    ...
    return Links.paginateDimensionNamesOrValues(dimNames, paging_limit, uriInfo);
  }
}
