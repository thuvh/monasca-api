...
public class NotificationMethodTypesResource {
  ...
  // Convenient method for testing purpose
  void setNotificationMethods(List<String> notificationMethods)
  {
      validNotificationMethods = notificationMethods;
  }
  ...
  public Response list(@Context UriInfo uriInfo) throws UnsupportedEncodingException {
     ...
     for (String method_type: validNotificationMethods){
