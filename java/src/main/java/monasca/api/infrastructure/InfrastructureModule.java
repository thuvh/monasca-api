...
public class InfrastructureModule extends AbstractModule {
  ...
  protected void configure() {
    final boolean hibernateEnabled = config.hibernate.getSupportEnabled();
  ...
  private void bindUtils(final boolean hibernateEnabled) {
    final Class<? extends Utils> implementation = hibernateEnabled ? HibernateUtils.class : MySQLUtils.class;
