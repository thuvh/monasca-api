...
public class AlarmStateHistoryVerticaRepoHibernateImpl implements AlarmStateHistoryRepo {

  private static final Logger logger =
      LoggerFactory.getLogger(AlarmStateHistoryVerticaRepoHibernateImpl.class);
  ...
  @Inject
  public AlarmStateHistoryVerticaRepoHibernateImpl(
  ...
  public List<AlarmStateHistory> find(
    ...
    List<String> alarmIds = this.hibernateUtils.findAlarmIds(tenantId, dimensions);
