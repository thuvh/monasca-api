...
public class DimensionVerticaRepoImpl implements DimensionRepo {
  ...
  @Override
  public List<DimensionValues> findValues(
    String metricName,
    String tenantId,
    ...
    int limit) throws Exception
  {
    ...
    try (Handle h = db.open()) {
      ...
      for (Map<String, Object> row : rows) {
        ...
        DimensionValues dimensionValues = new DimensionValues(metricName, dimensionName, dimensionValue);
  ...
  @Override
  public List<DimensionNames> findNames(
          String metricName,
          String tenantId,
          String offset,
          int limit) throws Exception
  {
    ...
    try (Handle h = db.open()) {
      ...
      for (Map<String, Object> row : rows) {
        ...
        DimensionNames dimensionNames = new DimensionNames(metricName, dimensionName);
        dimensionNamesList.add(dimensionNames);
      }
