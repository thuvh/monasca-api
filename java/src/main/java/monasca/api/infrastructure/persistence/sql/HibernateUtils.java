...
public class HibernateUtils
  ...
  private static final String FIND_ALARM_IDS_SQL = new StringBuilder()
      .append("select distinct a.id, ad.created_at ")
      .append("from alarm as a ")
      .append("join alarm_definition as ad on a.alarm_definition_id = ad.id ")
      .append("%s ")
      .append("where ad.tenant_id = :tenantId and ad.deleted_at is NULL ")
      .append("order by ad.created_at")
      .toString();
