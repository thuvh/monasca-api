...
public class StatisticVerticaRepoImpl implements StatisticRepo {
  ...
  public List<Statistics> find(String tenantId, String name, Map<String, String> dimensions,
                               DateTime startTime, DateTime endTime, List<String> statisticsCols,
    ...
    try (Handle h = db.open()) {
      ...
      Set<byte[]> dimDefIdSet = byteMap.keySet();
      String sql = createQuery(dimDefIdSet, period, startTime, endTime, offset, statisticsCols);
