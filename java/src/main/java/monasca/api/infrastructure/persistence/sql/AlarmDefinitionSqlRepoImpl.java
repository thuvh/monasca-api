...
public class AlarmDefinitionSqlRepoImpl
  ...
  private ResultTransformer alarmDefResultTransformer = null;
  ...
  public List<AlarmDefinition> find(String tenantId, String name, Map<String, String> dimensions, String offset, int limit) {
    ...
    try {
      ...
      final Query qAlarmDefinition = session
          ...
          .setResultTransformer(this.getAlarmDefResultTransformerLazy());
  ...
  private ResultTransformer getAlarmDefResultTransformerLazy() {
    if (this.alarmDefResultTransformer == null) {
      this.alarmDefResultTransformer = new ResultTransformer() {
    ...
    return this.alarmDefResultTransformer;
  }
