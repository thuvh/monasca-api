...
/**
 * Base function for DimensionNames and DimensionValues.
 */
public class DimensionBase extends AbstractEntity {
    @JsonInclude(JsonInclude.Include.NON_NULL)
    private String metricName;
    private List<String> dimensionInfo;

    public DimensionBase(String metricName, List<String> dimensionInfo) {
