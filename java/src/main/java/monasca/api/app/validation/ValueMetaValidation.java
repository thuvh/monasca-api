...
public final class ValueMetaValidation {
  ...
  private static void verifyValueMetaStringLength(Map<String, String> valueMeta) {

    try {
      String valueMetaString = objectMapper.writeValueAsString(valueMeta);
      ...
      throw Exceptions.unprocessableEntity("Failed to serialize valueMeta combinations %s", valueMeta);
    }
  }
}
