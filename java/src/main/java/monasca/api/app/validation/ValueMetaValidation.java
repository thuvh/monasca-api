...
public final class ValueMetaValidation {
  ...
  //
  // To be safe, we're assuming UTF-32 encoding (4 bytes per char), so we'll
  // set string length to 2048/4.
  //
  private static final int VALUE_META_VALUE_MAX_LENGTH = 512;
