...
public final class ValueMetaValidation {
  ...
  private static final Map<String, String> emptyValueMeta = Collections.unmodifiableMap(new HashMap<String, String>());
  ...
  public static void validate(Map<String, String> valueMetas) {
    if (valueMetas.size() > VALUE_META_MAX_NUMBER) {
      throw Exceptions.unprocessableEntity("Number of valueMeta  must be %d or less",
