...
sudo -E ${PYTHON:-python} -m pip install -e $DEVSTACK_PATH/monasca-tempest-plugin

(cd $TEMPEST_DIR; testr init)
(cd $TEMPEST_DIR; testr list-tests monasca_tempest_tests.tests.api > monasca_tempest_tests)
