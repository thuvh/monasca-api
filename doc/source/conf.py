...
project = u'Monasca Metric Dev Docs'
...
htmlhelp_basename = 'monasca-apidoc'
...
latex_documents = [
  (master_doc, 'monasca-api.tex', u'monasca-api Documentation',
...
man_pages = [
    (master_doc, 'monasca-api', u'monasca-api Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'monasca-api', u'monasca-api Documentation',
   author, 'monasca-api', 'Rest-API for alarming&monitoring in your cloud.',
   'Miscellaneous'),
]
