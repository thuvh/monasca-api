...
project = u'Openstack Monitoring Documentation'
...
latex_documents = [
    (master_doc, 'MonitoringApi.tex', u'Openstack Monitoring API Documentation',
     [author], 'manual'),
]
...
man_pages = [
    (master_doc, 'monitoringapi', u'Openstack Monitoring API Documentation',
     [author], 1)
]
