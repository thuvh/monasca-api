...
<<<<<<< 41bd12ee2007c12ce8383bf142ebe23a6a7594f5
...
Monasca uses a REST API for high-speed metrics and logs processing and
querying. It integrates a streaming alarm engine, a notification engine and an
aggregation engine.
...
.. toctree::
   ...
   contributor/index
=======
performant, and fault-tolerant. It provides an extensible platform for advanced
monitoring that can be used by both operators and tenants to gain operational
insights about their infrastructure and applications.

Monasca uses REST API for high-speed metrics and logs processing and querying.
It integrates a streaming alarm engine, notification engine as well as
aggregation engine.

The use cases you can implement with Monasca are very diverse. Monasca follows
micro-services architecture, with several services spit across multiple
repositories. Each module is designed to provide a discrete service in the
overall monitoring solution and can be deployed or omitted according to
operators/customers needs.
...
>>>>>>> Update Monasca documenation page
