...
<https://storyboard.openstack.org/#!/project_group/59>` as new Story.

The initial story primarily needs to express the intent of the idea with
enough details that it can be evaluated for compatibility with the Monasca
...
then used to track all the related code reviews.  Monasca team members will
