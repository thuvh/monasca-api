...
project = u'Monasca Metric Ref Guide'
...
htmlhelp_basename = 'monascametricapi-api-ref'
...
latex_documents = [
    (master_doc, 'MonascaMetricApi.tex', u'Monasca Metric API Documentation',
...
man_pages = [
    (master_doc, 'monascametricapi', u'Monasca Metric API Documentation',
...
texinfo_documents = [
    (master_doc, 'MonascaMetricAPI', u'Monasca Metric API Documentation',
     u'OpenStack Foundation', 'MonascaMetricAPI', 'Monasca Metric API',
     'Miscellaneous'),
]
