...
global_opts = [
    ...
    cfg.ListOpt('default_authorized_roles', default=['admin'], help='The default authorized roles'),
    cfg.ListOpt('agent_authorized_roles', default=['agent'], help='The agent authorized roles'),
    cfg.ListOpt('delegate_authorized_roles', default=['admin'], help='The delegate authorized roles')
]

cfg.CONF.register_opts(global_opts)

messaging_opts = [
    cfg.StrOpt('message_queue', default='kafka', help='The message queue to use'),
...
db_opts = [
    cfg.StrOpt('metrics_db', default='influxdb', help='The database to use for metrics')
]

db_group = cfg.OptGroup(name='db', title='db')
cfg.CONF.register_group(db_group)
cfg.CONF.register_opts(db_opts, db_group)
