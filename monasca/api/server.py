...
repositories_opts = [
    cfg.StrOpt('metrics_driver', default='influxdb', help='The database driver to use for metrics'),
    cfg.StrOpt('events_driver', default='influxdb', help='The database driver to use for events')
]
