...
class AlarmDefinitionsRepository(mysql_repository.MySQLRepository,
    ...
    def delete_alarm_definition(self, tenant_id, alarm_definition_id):
        ...
        cursor.execute("""delete from alarm where alarm_definition_id = %s""",
                       [alarm_definition_id])
    ...
    def create_alarm_definition(self, tenant_id, name, expression,
        ...
        for sub_expr in sub_expr_list:
            ...
            sub_expr.threshold.encode('utf8'), sub_expr.period.encode('utf8'),
            ...
            for dimension in sub_expr.dimensions_as_list:
                ...
                cursor.execute("""insert into sub_alarm_definition_dimension(
                            ...
                            value)
                            values(%s,%s,%s)""", (
                sub_alarm_definition_id, parsed_dimension[0].encode('utf8'),
