...
class AlarmDefinitionsRepository(mysql_repository.MySQLRepository,
    ...
    def update_or_patch_alarm_definition(self, tenant_id, alarm_definition_id,
        ...
        with cnxn:
            ...
            return updated_row, (
                {'old': old_sub_alarm_defs_dict_by_id,
                 'changed': changed_sub_alarm_defs_dict_by_id,
                 'new': new_sub_alarm_defs_dict_by_id,
                 'unchanged': unchanged_sub_alarm_defs_dict_by_id
                })
