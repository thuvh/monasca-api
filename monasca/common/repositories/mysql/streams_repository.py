...
class StreamsRepository(mysql_repository.MySQLRepository,
    ...
    base_query = """
          select sd.id, sd.tenant_id, sd.name, sd.description,
            ...
            sd.fire_pipeline, sd.expire_pipeline, sd.actions_enabled,
    ...
    @mysql_repository.mysql_try_catch_block
    def get_stream_definitions(self, tenant_id, name, offset):
    ...
    def create_stream_definition(self,
        ...
        with cnxn:
            ...
            stream_definition_id = uuidutils.generate_uuid()
            cursor.execute("""insert into stream_definition(
                ...
                description.encode('utf8'), select_by.encode('utf8'),
                group_by.encode('utf8'), fire_criteria.encode('utf8'),
                expiration, fire_pipeline.encode('utf8'),
                expire_pipeline.encode('utf8'), now, now))
